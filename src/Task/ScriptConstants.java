...
public class ScriptConstants {
    ...
    public final static String[] DO_NOT_DROP = {"Feather", "Fishing bait", "Fish offcuts", "Barbarian rod", "Pearl barbarian rod", "Clue bottle"};

    public final static String[] BAITS = {"Feather", "Fishing bait", "Fish offcuts"};
